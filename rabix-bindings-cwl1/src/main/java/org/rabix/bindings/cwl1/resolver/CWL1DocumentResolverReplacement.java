...
public class CWL1DocumentResolverReplacement {

  private final JsonNode parentNode;
  private final JsonNode referenceNode;
  private final String normalizedReferencePath;
  
  public CWL1DocumentResolverReplacement(JsonNode parentNode, JsonNode referenceNode, String normalizedReferencePath) {
    super();
  ...
  public boolean equals(Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    CWL1DocumentResolverReplacement other = (CWL1DocumentResolverReplacement) obj;
  ...
  public String toString() {
    return "CWL1DocumentResolverReplacement [normalizedReferencePath=" + normalizedReferencePath + ", parentNode=" + parentNode
