...
public class CWL1BindingHelper extends CWL1BeanHelper {
   ...
   */
  public static Object evaluateOutputEval(CWL1Job job, Object output, Object binding) throws CWL1ExpressionException {
    Object outputEval = getOutputEval(binding);
    return CWL1ExpressionResolver.resolve(outputEval, job, output);
  }
