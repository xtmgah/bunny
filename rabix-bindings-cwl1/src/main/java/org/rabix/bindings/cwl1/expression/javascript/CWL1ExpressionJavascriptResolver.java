...
public class CWL1ExpressionJavascriptResolver {
   ...
   */
  public static Object evaluate(Object context, Object self, String expr, List<String> engineConfigs) throws CWL1ExpressionException {
    ...
    cx.setClassShutter(new CWL1ExpressionDenyAllClassShutter());
    ...
    try {
      ...
      throw new CWL1ExpressionException(msg, e);
    } finally {
      Context.exit();
    }
  }
