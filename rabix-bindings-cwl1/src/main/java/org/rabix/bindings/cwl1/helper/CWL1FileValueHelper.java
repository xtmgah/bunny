...
public class CWL1FileValueHelper extends CWL1BeanHelper {
  ...
  public static void setFileType(Object raw) {
    setValue(CWL1SchemaHelper.KEY_JOB_TYPE, CWL1SchemaHelper.TYPE_JOB_FILE, raw);
  }
  ...
  public static Set<String> flattenPaths(Object value) {
    ...
    if (value == null) {
      return paths;
    } else if (CWL1SchemaHelper.isFileFromValue(value)) {
  ...
  private static String loadContents(Object fileData) throws IOException {
    String path = CWL1FileValueHelper.getPath(fileData);
  ...
  public static FileValue createFileValue(Object value) {
    String path = CWL1FileValueHelper.getPath(value);
    String checksum = CWL1FileValueHelper.getChecksum(value);
    Long size = CWL1FileValueHelper.getSize(value);
    
    Map<String, Object> properties = new HashMap<>();
    properties.put(CWL1BindingHelper.KEY_SBG_METADATA, CWL1FileValueHelper.getMetadata(value));
  ...
  public static Map<String, Object> createFileRaw(FileValue fileValue) {
    ...
    if (properties != null) {
      setMetadata(properties.get(CWL1BindingHelper.KEY_SBG_METADATA), raw);
    }
