...
public class CWL1InputPort extends ApplicationPort {
  ...
  @JsonCreator
  public CWL1InputPort(@JsonProperty("id") String id, @JsonProperty("default") Object defaultValue, @JsonProperty("type") Object schema, 
  ...
  public String toString() {
    return "CWL1InputPort [inputBinding=" + inputBinding + ", id=" + getId() + ", schema=" + getSchema() + ", scatter=" + getScatter() + "]";
  }
