 ...
 */
public class CWL1CommandLinePart {
  ...
  private List<Object> flatten(List<Object> parts) {
    ...
    for (Object partObj : parts) {
      if (partObj instanceof CWL1CommandLinePart) {
        CWL1CommandLinePart part = (CWL1CommandLinePart) partObj;
  ...
  public CWL1CommandLinePart sort() {
  ...
  public static class Builder {
    ...
    public CWL1CommandLinePart build() {
      CWL1CommandLinePart commandLinePart = new CWL1CommandLinePart();
  ...
  public static class CommandLinePartComparator implements Comparator<Object> {
    ...
    public int compare(Object o1, Object o2) {
      if (o1 instanceof CWL1CommandLinePart && o2 instanceof CWL1CommandLinePart) {
        CWL1CommandLinePart part1 = (CWL1CommandLinePart) o1;
        CWL1CommandLinePart part2 = (CWL1CommandLinePart) o2;
    ...
    public int compare(CWL1CommandLinePart o1, CWL1CommandLinePart o2) {
      if (o1 instanceof CWL1CommandLinePart && o2 instanceof CWL1CommandLinePart) {
        CWL1CommandLinePart clp1 = (CWL1CommandLinePart) o1;
        CWL1CommandLinePart clp2 = (CWL1CommandLinePart) o2;
