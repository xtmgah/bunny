...
public class CommandLinePrinter implements IterationCallback {
  ...
  public CommandLinePrinter(File outputDir, JobService jobService, VariableService variableService, LinkService linkService, ContextService contextService, DAGNodeDB nodeDB) {
    this.nodeDB = nodeDB;
    this.jobService = jobService;
    this.variableService = variableService;
    this.contextService = contextService;
    this.linkService = linkService;
    this.outputDir = new File("/Users/janko/Desktop/siki_wagner");
  }
