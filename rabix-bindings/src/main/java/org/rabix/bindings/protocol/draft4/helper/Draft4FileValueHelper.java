...
public class Draft4FileValueHelper extends Draft4BeanHelper {
  ...
  public static void setFileType(Object raw) {
    setValue(Draft4SchemaHelper.KEY_JOB_TYPE, Draft4SchemaHelper.TYPE_JOB_FILE, raw);
  }
  ...
  public static Set<String> flattenPaths(Object value) {
    ...
    if (value == null) {
      return paths;
    } else if (Draft4SchemaHelper.isFileFromValue(value)) {
  ...
  private static String loadContents(Object fileData) throws IOException {
    String path = Draft4FileValueHelper.getPath(fileData);
  ...
  public static FileValue createFileValue(Object value) {
    String path = Draft4FileValueHelper.getPath(value);
    String checksum = Draft4FileValueHelper.getChecksum(value);
    Long size = Draft4FileValueHelper.getSize(value);
    
    Map<String, Object> properties = new HashMap<>();
    properties.put(Draft4BindingHelper.KEY_SBG_METADATA, Draft4FileValueHelper.getMetadata(value));
