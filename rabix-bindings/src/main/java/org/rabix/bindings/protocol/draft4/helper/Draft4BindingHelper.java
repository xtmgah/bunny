...
public class Draft4BindingHelper extends Draft4BeanHelper {
   ...
   */
  public static Object evaluateOutputEval(Draft4Job job, Object output, Object binding) throws Draft4ExpressionException {
    Object outputEval = getOutputEval(binding);
    return Draft4ExpressionResolver.resolve(outputEval, job, output);
  }
