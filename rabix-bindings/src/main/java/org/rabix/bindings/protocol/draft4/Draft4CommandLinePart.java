 ...
 */
public class Draft4CommandLinePart {
  ...
  private List<Object> flatten(List<Object> parts) {
    ...
    for (Object partObj : parts) {
      if (partObj instanceof Draft4CommandLinePart) {
        Draft4CommandLinePart part = (Draft4CommandLinePart) partObj;
  ...
  public Draft4CommandLinePart sort() {
  ...
  public static class Builder {
    ...
    public Draft4CommandLinePart build() {
      Draft4CommandLinePart commandLinePart = new Draft4CommandLinePart();
  ...
  public static class CommandLinePartComparator implements Comparator<Object> {
    ...
    public int compare(Object o1, Object o2) {
      if (o1 instanceof Draft4CommandLinePart && o2 instanceof Draft4CommandLinePart) {
        Draft4CommandLinePart part1 = (Draft4CommandLinePart) o1;
        Draft4CommandLinePart part2 = (Draft4CommandLinePart) o2;
    ...
    public int compare(Draft4CommandLinePart o1, Draft4CommandLinePart o2) {
      if (o1 instanceof Draft4CommandLinePart && o2 instanceof Draft4CommandLinePart) {
        Draft4CommandLinePart clp1 = (Draft4CommandLinePart) o1;
        Draft4CommandLinePart clp2 = (Draft4CommandLinePart) o2;
