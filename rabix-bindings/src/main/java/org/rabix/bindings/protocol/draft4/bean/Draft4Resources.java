...
public class Draft4Resources {
  ...
  @JsonCreator
  public Draft4Resources(@JsonProperty("high_io") boolean highIO, @JsonProperty("cpu") Integer cpu,
  ...
  public boolean equals(Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    Draft4Resources other = (Draft4Resources) obj;
    if (cpu == null) {
      if (other.cpu != null)
        return false;
