...
public class Draft4ExpressionJavascriptResolver {
   ...
   */
  public static Object evaluate(Object context, Object self, String expr, List<String> engineConfigs) throws Draft4ExpressionException {
    ...
    cx.setClassShutter(new Draft4ExpressionDenyAllClassShutter());
    ...
    try {
      ...
      throw new Draft4ExpressionException(msg, e);
    } finally {
      Context.exit();
    }
  }
